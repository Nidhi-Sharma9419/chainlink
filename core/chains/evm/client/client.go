...
type Client interface {
	...
	HeightByBlockType(ctx context.Context, finalityType string) (int64, error)
...
func (client *client) HeightByBlockType(ctx context.Context, finalityType string) (int64, error) {
