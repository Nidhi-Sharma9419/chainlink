...
// EvmHeadTrackerTotalUnfinalizedHeadsLimit provides a mock function with given fields:
func (_m *ChainScopedConfig) EvmHeadTrackerTotalUnfinalizedHeadsLimit() uint32 {
	ret := _m.Called()
